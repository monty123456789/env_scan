...
void draw() {
  ...
  { 
    ...
    if (va == 1000.9 || coList.size() > rotation-2 ) { //|| coList.size() > 90
      coList.clear();
      //fullList.clear();
      //newLine +=1;
      count = 0.0;
